  ...
  return (props.trigger) ? (
    <div className="popup">
      ...
      <div className="flex flex-col-reverse">
        ...
        {/* <Button className="send-btn mt-6 items-center hover:scale-95 transition-transform duration-200" size={115} onClick={() => props.setTrigger(false)}>Повернутись</Button> */}
