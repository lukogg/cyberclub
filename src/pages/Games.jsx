  ...
  return (
    <>
      <div className="pt-[4.75rem] lg:pt-[5.25rem] overflow-hidden">
        ...
        <div className="mt-16 mb-16 ml-6 mr-6 flex flex-wrap justify-center">
              ...
              <div className="hover:scale-110 transform transition-transform duration-500">
                <SvgBorder key={index}>
                  <div className="noselect flex items-center gap-2 ">
                    <img src={game.logo} alt={game.name} className="lg:w-12 lg:h-12 w-8 h-8 mr-2" />
                    <span className="lg:text-2xl text-lg">{game.name}</span>
                  </div>
                </SvgBorder>
              </div>
            ))}
